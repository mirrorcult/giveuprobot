package jam
{
   ...
   public class Player extends Moveable
   {
      ...
      public static const SprIdle:Spritemap = FP.getSprite(ImgIdle,10,18,true,false,5,13);
      
      private static const SprThrowUp:Spritemap = FP.getSprite(ImgThrowUp,10,17,true,false,5,12);
      
      private static const ImgThrowUp:Class = Player_ImgThrowUp;
      
      private static const SprThrow:Spritemap = FP.getSprite(ImgThrow,10,17,true,false,5,12);
      
      private static const SprThrowDown:Spritemap = FP.getSprite(ImgThrowDown,10,17,true,false,5,12);
      
      private static const ImgFall:Class = Player_ImgFall;
      
      private static const ImgIdle:Class = Player_ImgIdle;
      
      private static const SprJump:Spritemap = FP.getSprite(ImgJump,10,18,true,false,5,13);
      
      private static const ImgRun:Class = Player_ImgRun;
      
      private static const ImgGrapple:Class = Player_ImgGrapple;
      
      private static const SprGrappleAir:Spritemap = FP.getSprite(ImgGrappleAir,12,17,true,false,6,10);
      
      private static const ImgJump:Class = Player_ImgJump;
      
      private static const SprRun:Spritemap = FP.getSprite(ImgRun,12,17,true,false,6,12);
      
      private static const SprFall:Spritemap = FP.getSprite(ImgFall,10,17,true,false,5,12);
      
      private static const SprGrapple:Spritemap = FP.getSprite(ImgGrapple,12,17,true,false,6,12);
