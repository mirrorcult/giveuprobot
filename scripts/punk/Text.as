package punk
{
   ...
   public class Text extends Entity
   {
      ...
      private const FontDefault:Class = Text_FontDefault;
      ...
      {
         this._point.x = x - originX - FP.camera.x;
         this._point.y = y - originY - FP.camera.y;
         FP.screen.copyPixels(this._data,this._rect,this._point);
      }
